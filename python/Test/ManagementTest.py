...
class ManagementTest(unittest.TestCase):
	...
	def test_Trade_Position_Risk(self):
		...
		mgr = SecurityCacheSingleton.get()
		margin_risk_mgr: FixPctRiskManager = FixPctRiskManager(margin_pos_mgr, {'TotalRiskPercentage': 2, 'RiskPerSharePercentage': 2})
		sec: Future = mgr.get_security("HSI")
		...
		margin_quote = margin_risk_mgr.get_open_quantity('HSI', Side.Buy, 25000)
